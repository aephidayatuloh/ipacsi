...
#
#
#' @title Perform calculation for Responents Satisfaction Index and Importance Performance Analysis
#' @description Measures Responents Satisfaction Index and Importance Performance Analysis from survey data.
...
#' @param firstrow Logical. Is the attribute name at first row of file?
#' @param firstcol Logical. Is the respndent id at first column of file
#' @return list
#'
